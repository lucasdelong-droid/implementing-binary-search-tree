...
# Assignment: Implementing Binary Tree Operations

## Introduction

Imagine we are software engineers tasked with developing a binary tree management system for a university database application. This system needs to handle various operations such as search, insert, update, and delete efficiently for student records.
...
- Implement an interactive menu allowing us to perform operations and view results dynamically.

## Pseudo-code Instructions:

1. **Define the `TreeNode` Class**:
   - Create a class called `TreeNode`.
   - Define the `__init__` method to initialize `student_id`, `name`, `left`, and `right` attributes.

**Pseudo-code for `TreeNode` Class**:

```pseudo
class TreeNode:
    - Initialize the class with student_id, name, left child, and right child attributes.
```
...
class BinaryTree:
    ...
    - Define methods to create full, complete, degenerate, and skewed binary trees.
...
Define insert function:
  ...
  - Else, use helper function to recursively insert in left or right subtree based on availability.
...
Define delete function:
  - Use helper function to recursively delete node in left or right subtree.
  - Return updated root.
...
Define _find_min helper function:
  - Traverse left subtree to find and return the node with the smallest value.
```

4. **Create Different Types of Binary Trees**:
   - Implement methods to create full, complete, degenerate, and skewed binary trees using the provided dataset.
...
Define create_full_binary_tree function:
  - Insert nodes in this order: [(1, "Alice"), (2, "Bob"), (3, "Charlie"), (4, "David"), (5, "Eve"), (6, "Frank"), (7, "Grace")]
  - Ensure the structure is a full binary tree.
  - Store initial values in values list.

# Complete Binary Tree
Define create_complete_binary_tree function:
  - Insert nodes in this order: [(1, "Alice"), (2, "Bob"), (3, "Charlie"), (4, "David"), (5, "Eve"), (6, "Frank")]
  - Ensure the structure is a complete binary tree.
  - Store initial values in values list.

# Degenerate Tree
Define create_degenerate_tree function:
  - Insert nodes in this order: [(1, "Alice"), (2, "Bob"), (3, "Charlie"), (4, "David"), (5, "Eve")]
...
Define main function:
  - Initialize different types of binary trees and store them in a dictionary.
...
Initial values in the tree: [(1, "Alice"), (2, "Bob"), (3, "Charlie"), (4, "David"), (5, "Eve"), (6, "Frank"), (7, "Grace")]
1. Insert Node
2. Search for Node
3. Update Node Name
4. Delete Node
